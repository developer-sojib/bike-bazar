              ...
              <>
                {myBookings.length > 0 ? (
                    ...
                    <div className="col-span-3 flex flex-col space-y-2">
                      {myBookings.map(({ _id, bookings, data }) => {
                        return (
                          <div
                            key={bookings._id}
                            className="grid grid-cols-1 lg:grid-cols-4 gap-3 bg-white rounded-lg shadow-xl p-3 box-border">
                            {/* {/_ image _/} */}
                            ...
                            <div className="col-span-1 flex items-center lg:justify-end">
                              <button
                                className="btn-danger px-4 w-36 mr-auto lg:ml-auto  mt-4 bg-red-600 border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-indigo-500"
                  ...
                  <div className="h-96 space-y-6 flex items-center justify-center flex-col">
                    ...
                    <button
                      className="btn-danger px-4 w-36 mr-auto lg:ml-auto  mt-4 bg-red-600 border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-indigo-500 px-6"
